...
TEST(TestIsGameOver, King_In_Check_From_One_Piece_3)
{
	// Declare board //
...
TEST(TestIsGameOver, King_In_Check_From_One_Piece_4)
{
	// Declare board //
...
TEST(TestIsGameOver, King_In_Check_From_One_Piece_5)
{
	// Declare board //
