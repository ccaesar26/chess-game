...
King::King(EColor color, Position position)
	:Piece(color,EName::King,position)
{}

void King::GetMovesPossible(Position currentPos, std::function<PiecePtr(Position)> GetPieceFromBoard, PositionPieceSet& possibleMoves) const
{
